...
export const QuickExit: React.FC = () => {
  ...
  return (
    <button
      ...
      className="fixed bottom-4 right-4 z-[60] inline-flex min-h-11 items-center gap-2 rounded-full bg-nav px-4 py-2.5 text-sm font-bold text-on-nav shadow-lg transition-colors hover:bg-nav-hover"
    >
